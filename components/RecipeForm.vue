  ...
  <div class="grid gap-8">
    ...
    >
      <div class="w-full text-right">
        <ButtonSecondary v-bind:onClick="() => removeItem(index)"
    ...
    <div>
      <ButtonPrimary v-bind:onClick="addItem"> 材料を追加する </ButtonPrimary>
    </div>
    <label>
      作り方
    ...
    <div class="w-full text-right">
      <ButtonPrimary v-bind:onClick="submit"> レシピを保存する </ButtonPrimary>
    </div>
  </div>
</template>
